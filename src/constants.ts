...
export const REPOSITORIES_TOTAL_BY_TEAM = 'REPOSITORIES_TOTAL_BY_TEAM';
export const TEAM_DATA_MAP = 'TEAM_DATA_MAP';
export const ISSUES_TOTAL_BY_REPO = 'ISSUES_TOTAL_BY_REPO';
export const PULL_REQUESTS_TOTAL_BY_REPO = 'PULL_REQUESTS_TOTAL_BY_REPO';
export const MEMBERS_TOTAL_BY_TEAM = 'MEMBERS_TOTAL_BY_TEAM';
